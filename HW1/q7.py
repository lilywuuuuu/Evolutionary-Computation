...
def analyze(infos):
    ...
    if not os.path.exists("q7_output"):
        os.makedirs("q7_output")
    mean_info.to_csv("q7_output/mean_info.csv")
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("q7_output/max_fitness.png")
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("q7_output/fitness_over_generations.png")
    plt.close()
